...
<%
        ...
        String sql="INSERT INTO student(regno,name,program,branch,section,"
                ...
                + "hobby, password,status) VALUES ('"+regno+"','"+sname+"','"+program+"','"+branch+"','"+section+"','"+cdur+"','"+dob+"',"
                + "'"+category+"','"+daysch+"','"+mail+"','"+address+"','"+phone+"','"+bgroup+"','"+hobby+"','"+password+"','accepted')";
