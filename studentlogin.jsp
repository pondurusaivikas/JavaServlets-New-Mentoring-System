...
<div class="wrapper">
                        ...
                        <ul class="nav navbar-nav">
                            ...
                            <li>
                                ...
                                <ul class="dropdown-menu multi-level">
                                    ...
                                    <li><a href="http://moodle.v.ac.in" target="_blank">Moodle</a></li>
                            ...
                            <li>
                                ...
                                <ul class="dropdown-menu multi-level">
                                    ...
                                    <li><a href="professorlogin.html">Professor</a></li>
    ...
    <form method="post" action="studentlogindb.jsp">
        <table align="center">
            <caption><h1>Student Login</h1></caption>
            ...
            <tr><td><input type="submit" value="Login"></td><td align="center"><input type="reset" value="Clear"></td></tr>
        </table>
    </form>
